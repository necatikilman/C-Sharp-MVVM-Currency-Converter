...
namespace CurrencyConverter
{
    public class ExchangeRates
    {
        ...
        {
            rates.Add(new KeyValuePair<Currency, Currency>(Currency.EUR, Currency.EUR), 1.00);
            ...
            rates.Add(new KeyValuePair<Currency, Currency>(Currency.USD, Currency.USD), 1.00);
            ...
            rates.Add(new KeyValuePair<Currency, Currency>(Currency.GBP, Currency.GBP), 1.00);
            ...
            rates.Add(new KeyValuePair<Currency, Currency>(Currency.JPY, Currency.JPY), 1.00);
            ...
            rates.Add(new KeyValuePair<Currency, Currency>(Currency.AUD, Currency.AUD), 1.00);
